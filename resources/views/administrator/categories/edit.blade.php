   			...
   			<div class="row">
		    	<div class="col-lg-12">
		    		...
		    		@include('partials._message')
		          	<div class="card">
		            	<div class="card-header"><i class="fa fa-table"></i> Please Fill The Below Form To Update Product Category Details</div>
	            		<div class="card-body">
	            			<form action="{{route('category.update', $categ->category_id)}}" method="POST" enctype="multipart/form-data">
	            				{{ csrf_field() }}
		            			<div class="form-group row ">
		            				<div class="col-sm-6">
                                        <input type="text" class="form-control form-control-rounded" name="category_name" value="{{$categ->category_name}}" required placeholder="Enter The Category Name">
                                        <input type="hidden" name="prev_name" value="{{$categ->category_name}}">
					                ...
					                <div class="col-sm-6" align="center">
					                    <button type="submit" class="btn btn-success btn-lg btn-block">UPDATE THE  CATEGORY </button>
					                </div>
