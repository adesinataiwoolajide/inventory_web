   			...
   			<div class="row pt-2 pb-2">
		        <div class="col-sm-9">
				    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="{{route('supplier.edit', $sup->supplier_id)}}"> Edit Supplier</a></li>
   			...
   			<div class="row">
		    	<div class="col-lg-12">
		    		...
		    		@include('partials._message')
		          	<div class="card">
                        <div class="card-header"><i class="fa fa-table"></i> Please Fill The Below Form To Update The Supplier Details</div>
	            		<div class="card-body">
	            			<form action="{{route('supplier.update', $sup->supplier_id)}}" method="POST" enctype="multipart/form-data">
	            				{{ csrf_field() }}
		            			<div class="form-group row ">
                                        <input type="hidden" value="{{$sup->email}}" name="prev_email">
                                        <input type="hidden" value="{{$sup->name}}" name="prev_namel">
		            				<div class="col-sm-3">
                                        <label>Supplier Name</label>
                                        <input type="text" name="name" value="{{$sup->name}}" class="form-control form-control-rounded" required placeholder="Enter The Supplier Name">
                                    ...
                                    <div class="col-sm-3">
                                        ...
                                        <input type="number" name="phone_one"  value="{{$sup->phone_one}}" class="form-control form-control-rounded" required placeholder="Enter The Phone One">
                                        <span style="color: red">** This Field is Required **</span>
                                    ...
                                    <div class="col-sm-3">
                                        <label>E-Mail</label>
                                        <input type="email" name="email"  value="{{$sup->email}}" class="form-control form-control-rounded" required 
                                    ...
                                    <div class="col-sm-3">
                                        ...
                                        <select class="form-control form-control-rounded" name="state" required>
                                            <option value="{{$sup->state}}">  {{$sup->state}}</option>
                                    ...
                                    <div class="col-sm-3">
                                        <label>City</label>
                                        <input type="text" name="city"  value="{{$sup->city}}" class="form-control form-control-rounded" required 
                                    ...
                                    <div class="col-sm-3">
                                        ...
                                        <select class="form-control form-control-rounded" name="country" required>
                                            <option value="{{$sup->country}}">  {{$sup->country}} </option>
                                            <option value=""> </option>
                                    ...
                                    <div class="col-sm-3">
                                        ...
                                        name="address" placeholder="Enter The Supplier Address">{{$sup->address}}</textarea>
                                        <span style="color: red">** This Field is Required **</span>
