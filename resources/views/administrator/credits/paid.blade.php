                    ...
                    @include('partials._message')
		          	<div class="card">
                        @if(auth()->user()->hasRole('Administrator') OR(
                            ...
                            @else
                                <div class="card-header"><i class="fa fa-table"></i> 
                                    List of All Paid Credit in All Ware House
                                </div>
                        ...
                        @else
                            @if(count($cre) ==0)
                                <div class="card-header" align="center" style="color: red">
                                    <i class="fa fa-table"></i> The List of Paid Credit in {{$inv->name}} Warehouse is Empty
                                </div>

                            @else
                                <div class="card-header"><i class="fa fa-table"></i> 
                                    List of All Paid Credit in {{$inv->name}} Ware House
                                </div>
